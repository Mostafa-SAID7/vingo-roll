...
export const Route = createFileRoute("/contact")({
  head: () =>
    pageHead({
      title: "Contact Vingo Roll",
      description:
        "Questions about measuring, fabrics, lead times or an existing order — talk to a window treatment specialist.",
      path: "/contact",
    }),
  component: Page,
});
  ...
  return (
    <>
      ...
      <PageHeader
        ...
        description="Measuring questions, fabric advice or an existing order — we answer within one business day."
      />
      <Section>
        {sent ? (
          <div className="border-border max-w-xl rounded-sm border p-8" role="status">
            ...
            <p className="text-muted-foreground mt-3 text-sm leading-relaxed">
              Thank you, {form.name}. This is a demonstration form, so nothing was actually sent.
            </p>
