...
export const Route = createFileRoute("/guides/shipping")({
  head: () =>
    pageHead({
      title: "Shipping & Lead Times | Vingo Roll",
      description:
        "Lead times, delivery and tracking for made-to-order curtains, shades and blinds.",
      ...
      <Section>
        <div className="max-w-3xl space-y-5">
          ...
          <p className="text-muted-foreground leading-relaxed">
            Made-to-order treatments are cut, sewn and inspected in 3–4 weeks. Stocked hardware and
            swatches ship in 2–3 business days.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            Everything ships tracked. Long drapery ships rolled rather than folded to avoid set
            creases.
          </p>
          <p className="text-muted-foreground leading-relaxed">
            Delivery dates shown anywhere on this site are indicative and for demonstration
            purposes.
          </p>
        </div>
      </Section>
