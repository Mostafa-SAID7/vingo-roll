...
export const Route = createFileRoute("/services/")({
  head: () =>
    pageHead({
      title: "Services — Consultation, Measuring & Installation | Vingo Roll",
      description:
        "Design consultation, professional measuring, installation and free material swatches.",
      path: "/services",
    }),
  component: Page,
});
